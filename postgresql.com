...
<html lang="en">
 <head>
  ...
  <meta property="article:published_time" content="2022-01-01T17:36:35.389197" />
  ...
  <link href="/media/css/fontawesome.css?81ad19fc" rel="stylesheet">
  <link rel="stylesheet" href="/media/css/bootstrap-4.4.1.min.css">
  <link rel="shortcut icon" href="/favicon.ico" />
  
    <link rel="stylesheet" type="text/css" href="/dyncss/base.css?81ad19fc">
    ...
    <div class="col-lg-5">
      <div class="sidebar">
        ...
        <ul class="divided">
            ...
            <li>
              <h3><a href="/about/news/high-performance-sql-cluster-engine-pgspider-200-released-2384/">High-Performance SQL Cluster Engine PGSpider 2.0.0 released</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2021-12-27 by Toshiba</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/influxdb-fdw-111-released-2377/">InfluxDB FDW 1.1.1 released</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2021-12-27 by Toshiba</li>
              </ul>
            </li>
            ...
            <li>
              <h3><a href="/about/news/pg_query_rewrite-003-released-2386/">pg_query_rewrite 0.0.3 released</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2021-12-27 by Pierre Forstmann</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/griddb-fdw-211-released-2378/">GridDB FDW 2.1.1 released</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2021-12-27 by Toshiba</li>
              </ul>
            </li>
            ...
            <li>
              <h3><a href="/about/news/sqlite-fdw-211-released-2383/">SQLite fdw 2.1.1 released</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2021-12-27 by Toshiba</li>
              </ul>
            </li>
...
<!-- Blog -->
     ...
     <!-- First Column First Row Planet PostgreSQL -->
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5en"> Ecommerce customer names with interesting Unicode characters</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Jon Jensen</li>
              <li><i class="far fa-clock"></i>&nbsp;2021-12-29</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5em"> Five Tips For a Healthier Postgres Database in the New Year</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Craig Kerstiens</li>
              <li><i class="far fa-clock"></i>&nbsp;2021-12-23</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5ek"> 🐘🚀 Triggers &amp; Stored Procedures for pure data integrity logic and performance</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Franck Pachot</li>
              <li><i class="far fa-clock"></i>&nbsp;2021-12-21</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5eg"> DLE 3.0: UI, persistent clones, PostgreSQL 14, more</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5ef"> 2021 Resume</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5ee"> PMM Now Supports Monitoring of PostgreSQL Instances Connecting With Any </a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Fernando Laudares Camargos</li>
              <li><i class="far fa-clock"></i>&nbsp;2021-12-20</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5ed"> The anatomy of a linux read call, part 2</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5ec"> Vibhor Kumar</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5eb"> PostGIS Day 2021 Highlights</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;REGINA OBE</li>
              <li><i class="far fa-clock"></i>&nbsp;2021-12-18</li>
            </ul>
          </div>
        </div>
 ...
 <!-- END SUBMIT A BUG -->
    ...
    <script src="/media/js/main.js?81ad19fc"></script>
